...
import { Github, Linkedin, Mail, Code2, CheckSquare, TrendingUp, Users } from 'lucide-react';
            ...
            {teamMembers.map((member, index) => (
              <div key={index} className="text-center">
                ...
                <div className="flex justify-center space-x-3">
                  <a href={member.github} className="text-gray-500 hover:text-gray-700">
                    <Github size={18} />
                  </a>
                  <a href={member.linkedin} className="text-gray-500 hover:text-gray-700">
                    <Linkedin size={18} />
                  </a>
                  <a href={`mailto:${member.name.toLowerCase()}@example.com`} className="text-gray-500 hover:text-gray-700">
                    <Mail size={18} />
                  </a>
                </div>
              </div>
